...
\usepackage{titletoc}
\ctexset{
	contentsname = {\zihao{-3} \htjc 目\quad 录},
	abstractname = {\bfseries\zihao{-3} \htjc 摘要\vspace{0.5cm}},
	section = {name = {,、},number = \chinese{section}},
	subsection = {name = {（,）},indent=2em, number=\chinese{subsection}},
}
\usepackage{titletoc}
\titleformat{\section}
{\zihao{-3}\bfseries\htjc\centering}
{\thesection、}
{0pt}
{}
\titleformat{\subsection}
{\zihao{-4}\bfseries\htjc}
...
\setCJKfamilyfont{zhsong}[AutoFakeBold=3]{STSong}
\newcommand{\stxjc}{\CJKfamily{zhsong}}
\setCJKfamilyfont{htj}{黑体-简}
...
\includegraphics[scale=.2]{xiaohui.pdf}
\hspace{0.3cm}
\begin{tabular}{c}
...
\zihao{-0} \textbf{\htjc 毕业论文}

\vspace{2cm}

\zihao{2} \textbf{\htjc 韩南地区旅游营销策略研究}
...
\begin{center}
\vspace{3ex}
\zihao{-3}\textbf{\htjc 译文一}\ \ \ \ \textbf{\htjc 测算全球价值链参与度和全球经济周期}\\
\vspace{1.5ex}
Zhi Wang\\
Shang-Jin Wei\\
Xinding Yu\\
...
\begin{center}
\vspace{3ex}
\zihao{-3}\textbf{\htjc 译文二}\quad\textbf{\htjc 全球价值链中的潜在和实际FDI溢出效应 - 外国投资者特征，吸收能力和传导渠道的作用}\\
\vspace{1.5ex}
Deborah Winkler\\
\vspace{1.5ex}
\zihao{-4}孙晔 \quad 译\\
